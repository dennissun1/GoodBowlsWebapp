...
class MyPureMap extends React.Component {
    ...
    componentDidMount() {
        if (!this.map) {
            ...
            this.updateMarkers([35.3016102,-78.2229939], "<b>Wise Farms</b>", "Sweet Potatoes<br />Greens (Collards/Kale)<br />Summer Squash<br />Cauliflower<br />Peas<br />Corn<br />Tomatoes","farm");
